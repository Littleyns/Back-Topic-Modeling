...
for i in range(len(listnames)):
    with io.open('trainset/'+listnames[i],'r',encoding="utf-8") as f:
...
CompareToPath = 'lol.txt' #mettre le repertoire du document à comparer
with io.open(CompareToPath, 'r', encoding='utf-8') as f:
